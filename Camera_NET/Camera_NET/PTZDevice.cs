...
namespace Camera_NET
{
    ...
    public class PTZDevice
    {
        ...
        public PTZDevice(string name, PTZType type)
        {
        ...
        public void Center()
        {
            MoveInternal(KSProperties.CameraControlFeature.KSPROPERTY_CAMERACONTROL_PAN, 0);
            MoveInternal(KSProperties.CameraControlFeature.KSPROPERTY_CAMERACONTROL_TILT, 0);
        }
        public void MoveXRelative(int x)
        {
            {
        ...
        public void MoveYRealtive(int y)
        {
            {
        ...
        public void Move(int x, int y) //TODO: Is this the best public API? Should work for Relative AND Absolute, right?
        {
           ...
           // if (y != 0)
            {
                MoveInternal(KSProperties.CameraControlFeature.KSPROPERTY_CAMERACONTROL_TILT, y);
            }

           // if (x != 0)
            {
                MoveInternal(KSProperties.CameraControlFeature.KSPROPERTY_CAMERACONTROL_PAN, x);
            }
        }

        public static int KSPROPERTY_CAMERACONTROL_FLAGS_MANUAL = 0X0001;
        public static int KSPROPERTY_CAMERACONTROL_FLAGS_AUTO = 0X0002;
        public static int KSPROPERTY_CAMERACONTROL_FLAGS_ABSOLUTE = 0X0000;
        public static int KSPROPERTY_CAMERACONTROL_FLAGS_RELATIVE = 0X0010;
